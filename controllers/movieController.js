...
const getAllMovies = async (req, res) => {
    ...
    try {
        ...
        res.status(200).json({status: 'success',allMovies: allMovies})
    }catch (e) {
...
const deleteMovie = async (req, res) => {
    try {
        ...
        res.status(200).json({code: 200,success: true,message:"Delete movie", deleteMovie: movie});
    }catch (e){
        return res.status(404).json({code: 404,message:"Not Found",error:e})
    }
}
const updateMovie = async (req, res) => {
    ...
    try {
        ...
        res.status(200).json({code: 200,success: true,message:"Update movie", updateMovie: movie});
    }catch (e){
        return res.status(404).json({code: 404,message:"Not Found",error:e})
    }
}
const getMovieDetails = async (req, res) => {
    try {
        ...
        res.status(200).json({code: 200,success: true,message:"Movie details", getMovieDetails: movie});
    }catch (e){
        return res.status(404).json({code: 404,message:"Not Found",error:e})
    }
}
